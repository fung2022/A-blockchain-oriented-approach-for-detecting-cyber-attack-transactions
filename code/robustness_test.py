...
def data_load(feature_data_path,train_data_path):
    """
    ...
    return (feature_data,train_data)
...
if __name__ == "__main__":
    ...
    train_data_path = "data/robust_dataset.csv"
    
    transaction_limit = 2000
    contamination = 0.05

    feature_data,train_data = data_load(feature_data_path,train_data_path)
    predict_result,time_cost = weif_execution(feature_data,train_data,transaction_limit,contamination,sigma=False)
