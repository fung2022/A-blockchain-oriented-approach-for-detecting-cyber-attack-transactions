...
target_data = pd.read_csv('data/labeled_transaction_data.csv',encoding='utf8').to_dict(orient='records')
...
"""evaluation"""
smart_contract_exploit_result = metric(predict_result,'smart contract exploit')
flash_loan_result = metric(predict_result,'flash loan attack')
authority_theft_result = metric(predict_result,'authority theft')
